    ...
    'initialize': function() {
        ...
        overviewer.coordBoxClass = L.Control.extend({
            ...
            render: function(latlng) {
                ...
                var r_x = Math.floor(Math.floor(w_coords.x / 16.0) / 16.0);
                var r_z = Math.floor(Math.floor(w_coords.z / 16.0) / 16.0);
        ...
        overviewerConfig.tilesets.forEach(function(obj, idx) {
            ...
            if (typeof(obj.center) == "object") {
                ...
                overviewer.collections.centers[obj.world][obj.path] = [ latlng, obj.maxZoom - 3 ];
            } else {
                overviewer.collections.centers[obj.world][obj.path] = [ [0, 0], obj.maxZoom - 3 ];
            }
